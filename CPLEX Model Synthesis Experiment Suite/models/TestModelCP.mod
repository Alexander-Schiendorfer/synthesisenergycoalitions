...
dvar int production[plants][TIMERANGE];
...
{string} softConstraints = {"c1_economically_optimal_b", "c1_economically_optimal_c", "c1_rate_ofchangeOpt_a", "c2_economically_good_b", "c2_economically_good_c", "c2_rate_ofchangePref_a", "c3_economically_acc_b", "c3_rate_ofchange_opt_c", "oc1", "oc2"};
...
c3_rate_ofchange_opt_c:( (running_c[t] == 1) => abs(production["c"][t] - production["c"][t+1]) <= production["c"][t]  * 0.1 && penalties["c3_rate_ofchange_opt_c"][t] == 0) || (!( (running_c[t] == 1) => abs(production["c"][t] - production["c"][t+1]) <= production["c"][t]  * 0.1) && penalties["c3_rate_ofchange_opt_c"][t] == 1);
...
powerPlantState_c[t] == IDLE_c => (powerPlantState_c[t+1] == IDLE_c || (powerPlantState_c[t+1] == STARTING_c && signal_c[t] == 1 && (countdown_c[t+1] == startupCountDown_c)));
...
c1_rate_ofchangeOpt_a:( (running_a[t] == 1) && (running_a[t+1] == 1) => abs(production["a"][t] - production["a"][t+1]) <= production["a"][t]  * 0.07 && penalties["c1_rate_ofchangeOpt_a"][t] == 0) || (!( (running_a[t] == 1) && (running_a[t+1] == 1) => abs(production["a"][t] - production["a"][t+1]) <= production["a"][t]  * 0.07) && penalties["c1_rate_ofchangeOpt_a"][t] == 2);
c2_rate_ofchangePref_a:( (running_a[t] == 1) && (running_a[t+1] == 1) => abs(production["a"][t] - production["a"][t+1]) <= production["a"][t]  * 0.10 && penalties["c2_rate_ofchangePref_a"][t] == 0) || (!( (running_a[t] == 1) && (running_a[t+1] == 1) => abs(production["a"][t] - production["a"][t+1]) <= production["a"][t]  * 0.10) && penalties["c2_rate_ofchangePref_a"][t] == 1);
}
};
/* SOFT-CONSTRAINTS
oc1
